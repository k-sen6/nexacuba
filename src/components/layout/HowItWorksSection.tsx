    ...
    <section id="como-funciona" className="py-24 px-5 bg-black relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">Tres pasos para conectar con vendedores en Cuba</p>
        </div>
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          {[
            { num: "1", title: "Explora Ofertas", desc: "Navega por cientos de productos de vendedores verificados en toda Cuba." },
