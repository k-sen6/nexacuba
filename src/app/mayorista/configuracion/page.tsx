          ...
          <div className="md:col-span-2 space-y-6">
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
              ...
              <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-blue-600/10 to-purple-600/10 border border-blue-500/20">
                <div>
                  ...
                  <p className="text-sm text-gray-400">Hasta 10 productos · Analytics básicos</p>
                </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
              ...
              <div className="space-y-4">
                {[
                  { label: "Nombre del Negocio", value: "TechCuba Store" },
                  { label: "WhatsApp", value: "+53 5 555 5555" },
                  { label: "Provincia", value: "La Habana" },
                  { label: "Email", value: "techcuba@email.com" },
                ].map((f) => (
